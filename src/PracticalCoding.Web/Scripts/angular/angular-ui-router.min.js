...
function (a, b, c) {
    ...
    function l(a) {
        ...
        for (var d in a) -1 == c.indexOf(d) && (b[d] = a[d]);
        return b
    }
    ...
    function q(a, b, e) {
        ...
        this.source = a;
        for (var q, r, s;
            (i = j.exec(a)) && (q = h(i, !1), !(q.segment.indexOf("?") >= 0)) ;) r = f(q.id, q.type, q.cfg, "path"), l += g(q.segment, r.type.pattern.source, r.squash), n.push(q.segment), m = j.lastIndex;
        s = a.substring(m);
        var t = s.indexOf("?");
        if (t >= 0) {
            var u = this.sourceSearch = s.substring(t);
            if (s = s.substring(0, t), this.sourcePath = a.substring(0, m + t), u.length > 0)
                for (m = 0; i = k.exec(u) ;) q = h(i, !0), r = f(q.id, q.type, q.cfg, "search"), m = j.lastIndex
        } else this.sourcePath = a, this.sourceSearch = "";
        l += g(s) + (b.strict === !1 ? "/?" : "") + "$", n.push(s), this.regexp = new RegExp(l, b.caseInsensitive ? "i" : c), this.prefix = n[0]
    }
    ...
    function s() {
        function a(a) {
            return null != a ? a.toString().replace("/", "%2F") : a
        }
        ...
        s.$$getDefaultValue = function (a) {
            ...
            function i(b, c) {
                ...
                return c ? c : b.type ? b.type instanceof r ? b.type : new r(b.type) : v.string
            }
            ...
            function t() {
                return "{Param:" + a + " " + b + " squash: '" + A + "' optional: " + z + "}"
            }
            var w = this,
                x = f(d);
            d = d || {}, b = i(d, b);
            var y = k();
            b = y ? b.$asArray(y, "search" === e) : b, "string" !== b.name || y || "path" !== e || x.value !== c || (x.value = "");
            var z = x.value !== c,
                A = l(d, z),
                B = p(d, y, z, A);
            M(this, {
    ...
    function t(a, d) {
        ...
        function h(c, d, e, f) {
            function g(a, b, c) {
                return "/" === n ? a : b ? n.slice(0, -1) + a : c ? n.slice(1) + a : a
            }

            function h(a) {
                function b(a) {
                    var b = a(e, c);
                    return b ? (I(b) && c.replace().url(b), !0) : !1
                }
            ...
            function m() {
                return i = i || d.$on("$locationChangeSuccess", h)
            }
            var n = f.baseHref(),
                o = c.url();
            return l || m(), {
                ...
                update: function (a) {
                    return a ? void (o = c.url()) : void (c.url() !== o && (c.url(o), c.replace()))
                },
                push: function (a, b, d) {
                    c.url(a.format(b || {})), d && d.replace && c.replace()
                },
                href: function (d, e, f) {
                    if (!d.validates(e)) return null;
                    var h = a.html5Mode();
                    b.isObject(h) && (h = h.enabled);
                    var i = d.format(e);
                    if (f = f || {}, h || null === i || (i = "#" + a.hashPrefix() + i), i = g(i, h, f.absolute), !f.absolute || !i) return i;
                    var j = !h && i ? "/" : "",
                        k = c.port();
                    return k = 80 === k || 443 === k ? "" : ":" + k, [c.protocol(), "://", c.host(), k, j, i].join("")
                }
            }
        }
        var i, j = [],
    ...
    function u(a, e) {
        ...
        function u(a, e, f, h, m, o, p) {
            ...
            return w.locals = {
                ...
                var f = l(a, e.relative);
                return G(f) ? x.$current !== f ? !1 : G(d) && null !== d ? b.equals(o, d) : !0 : c
                ...
                return G(e) ? G(x.$current.includes[e.name]) ? j(b, o) : !1 : c
        ...
        return {
            ...
            controller: ["$scope", "$element", "$attrs",
                function (d, e, f) {
                    ...
                    function h() {
                        return "undefined" != typeof f.uiSrefActiveEq ? a.$current.self === k && i() : k && a.includes(k.name) && i()
                    }
    ...
    q.prototype.concat = function (a, b) {
        ...
        return G(a) ? this.params[a] || null : this.params.$$keys()
        ...
        function c(a, b) {
            ...
            function d(a, c) {
                return function (d) {
                    K(d) || (d = [d]);
                    var e = n(d, a);
                    return c ? e.reduce(c, !0) : e && 1 == e.length && "auto" === b ? e[0] : e
                }
            }
            ...
            this.encode = d(c(this, a.encode)), this.decode = d(c(this, a.decode)), this.equals = d(c(this, a.equals), e), this.is = d(c(this, a.is), e), this.pattern = a.pattern, this.$arrayMode = b
        }
        if (!a) return this;

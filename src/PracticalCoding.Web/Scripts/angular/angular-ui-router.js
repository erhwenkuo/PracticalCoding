...
(function (window, angular, undefined) {
    ...
    function inheritParams(currentParams, newParams, $current, $to) {
        var parents = ancestors($current, $to),
            parentParams, inherited = {}, inheritList = [];
    ...
    function $UrlMatcherFactory() {
        ...
        function valToString(val) {
            return val != null ? val.toString().replace("/", "%2F") : val;
        }
        ...
        function angularEquals(left, right) {
        ...
        var $types = {}, enqueue = true,
            ...
            injector, defaultTypes = {
                ...
                date: {
                    encode: function (val) {
                        return [
                            val.getFullYear(), ('0' + (val.getMonth() + 1)).slice(-2), ('0' + val.getDate()).slice(-2)
                        ].join("-");
                    },
                    decode: function (val) {
                        return new Date(val);
        ...
        ParamSet.prototype = {
            ...
            $$validates: function $$validate(paramValues) {
                var result = true,
                    isOptional, val, param, self = this;
    ...
    angular.module('ui.router.util').run(['$urlMatcherFactory',
        function ($urlMatcherFactory) { }
    ]);
    ...
    function $StateProvider($urlRouterProvider, $urlMatcherFactory) {
        ...
        function registerState(state) {
            ...
            if (!state[abstractKey] && state.url) {
                $urlRouterProvider.when(state.url, ['$match', '$stateParams',
